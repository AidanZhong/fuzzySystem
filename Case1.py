...
class Case1:
    def __init__(self, unit=False) -> None:
        ...
        ColdMF = GenT2MF_Trapezoidal("GT2MF for coldly temperature", primer=ColdIT2MF,
        ...
        NormalMF = GenT2MF_Trapezoidal("GT2MF for normal temperature", primer=NormalIT2MF,
                                       numberOfzLevels=self.numberOfzLevels)
        ...
        ModerateMF = GenT2MF_Trapezoidal("GT2MF for moderate headache", primer=ModerateIT2MF,
                                         numberOfzLevels=self.numberOfzLevels)
        ...
        SevereMF = GenT2MF_Trapezoidal("GT2MF for severe headache", primer=SevereIT2MF,
                                       numberOfzLevels=self.numberOfzLevels)
        ...
        MediumMF = GenT2MF_Trapezoidal("GT2MF for medium urgency", primer=MediumIT2MF,
                                       numberOfzLevels=self.numberOfzLevels)
        ...
        CriticalMF = GenT2MF_Trapezoidal("GT2MF for critical urgency", primer=CriticalIT2MF,
                                         numberOfzLevels=self.numberOfzLevels)
        ...
        EmergencyMF = GenT2MF_Trapezoidal("GT2MF for emergency urgency", primer=EmergencyIT2MF,
                                          numberOfzLevels=self.numberOfzLevels)
        ...
        self.plotGen2MF3D("Headache Membership Functions", [MildMF, ModerateMF, SevereMF], self.headache.getDomain(),
                          100, True, True)
        self.plotGen2MF3D("Age Membership Functions", [ChildMF, AdultMF, ElderlyMF], self.age.getDomain(), 100, True,
                          True)

        # plot the Membership Function in 2D
        self.plotT1MFs("Temperature Membership Functions", [ColdUMF, NormalUMF, HotUMF], self.temperature.getDomain(),
                       200)
        self.plotGen2MF2D("Headache Membership Functions",
                          [MildUMF, MildLMF, ModerateUMF, ModerateLMF, SevereUMF, SevereLMF], self.headache.getDomain(),
                          200)
        self.plotGen2MF2D("Age Membership Functions", [ChildUMF, ChildLMF, AdultUMF, AdultLMF, ElderlyUMF, ElderlyLMF],
                          self.age.getDomain(), 200)
        self.plotT1MFs("Urgency Membership Functions", [LowUMF, MediumUMF, HighUMF, CriticalUMF, EmergencyUMF],
